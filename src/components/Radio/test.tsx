...
describe('<Radio />', () => {
  it('verificar se o radio está renderizando o label na cor branca', () => {
  ...
  it('verificar se o radio está renderizando o label na cor preta', () => {
  ...
  it('verificar se ao clicar vai mudar o status da radio', async () => {
